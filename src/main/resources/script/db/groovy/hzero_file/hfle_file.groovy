...
databaseChangeLog(logicalFilePath: 'script/db/hfle_file.groovy') {
    ...
    changeSet(author: "yupeng@going-link.com", id: "2021-06-11-hfle_file-addIndex") {
        createIndex(tableName: "hfle_file", indexName: "hfle_file_n4") {
            column(name: "tenant_id")
        }
    }

    changeSet(author: "qixiangyu@going-link.com", id: "2021-08-10-hfle_file-addOrderSeq") {
        addColumn(tableName: 'hfle_file') {
