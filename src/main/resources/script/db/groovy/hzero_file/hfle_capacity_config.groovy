...
databaseChangeLog(logicalFilePath: 'script/db/hfle_capacity_config.groovy') {
    changeSet(author: "qingsheng.chen@hand-china.com", id: "2019-01-02-hfle_capacity_config") {
        ...
        createTable(tableName: "hfle_capacity_config", remarks: "文件容量配置") {
            column(name: "capacity_config_id", type: "bigint(20)", autoIncrement: true ,   remarks: "表ID，主键，供其他表做外键")  {constraints(primaryKey: true)} 
            column(name: "tenant_id", type: "bigint(20)",  remarks: "租户ID，hpfm_tenant.tenant_id")  {constraints(nullable:"false")}  
            column(name: "total_capacity", type: "bigint(20)",  remarks: "总容量限制")  {constraints(nullable:"false")}  
            column(name: "total_capacity_unit", type: "varchar(" + 30 * weight + ")",  remarks: "")  {constraints(nullable:"false")}  
            column(name: "used_capacity", type: "bigint(20)",  remarks: "已使用容量")   
            column(name: "storage_unit", type: "varchar(" + 30 * weight + ")",  remarks: "存储大小限制单位，值集HFLE.STORAGE_UNTT,KB/MB")  {constraints(nullable:"false")}  
            column(name: "storage_size", type: "int(11)",  remarks: "存储大小")  {constraints(nullable:"false")}  
