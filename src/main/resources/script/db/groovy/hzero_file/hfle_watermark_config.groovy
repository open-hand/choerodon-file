...
databaseChangeLog(logicalFilePath: 'script/db/hfle_watermark_config.groovy') {
    ...
    changeSet(author: "hzero@hand-china.com", id: "2020-10-21-hfle_watermark_config") {
        addColumn(tableName: "hfle_watermark_config") {
            column(name: "company_id", type: "bigint", remarks: "公司ID，hpfm_company.company_id")
        }
        dropUniqueConstraint(tableName: "hfle_watermark_config", constraintName: "hfle_watermark_config_u1")
        addUniqueConstraint(columnNames:"watermark_code,tenant_id,company_id",tableName:"hfle_watermark_config",constraintName: "hfle_watermark_config_u1")
    }
}